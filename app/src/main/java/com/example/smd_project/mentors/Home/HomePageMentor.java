package com.example.smd_project.mentors.Home;
...
public class HomePageMentor extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_home_mentor_page);
    ...
    public void showCategories(View view) {
        Toast.makeText(HomePageMentor.this, "Log in Error: " + "Calling", Toast.LENGTH_SHORT).show();
    ...
    public void registerOrganization(View view) {
